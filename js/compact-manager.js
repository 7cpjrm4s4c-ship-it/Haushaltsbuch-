...
vAusgaben=function(){
  ...
  return `<div class="desktop-page-title">Ausgaben</div>
    <div class="card form-card"><div class="card-title">Variable Ausgabe erfassen</div>
    ...
    <div class="card"><div class="list-head"><div class="card-title" style="margin:0">Gespeicherte Ausgaben</div><span class="muted">${MF[mo]} ${y}</span></div><div class="manager-groups">${groups||'<div class="manager-empty">Noch keine Ausgaben in diesem Monat.</div>'}</div></div>`;
};
...
vUebersicht=function(){
  ...
  return `<div class="desktop-page-title">Fixkosten</div>
    ...
    <div class="card"><div class="list-head"><div class="card-title" style="margin:0">Gespeicherte Positionen</div><span class="muted">${categories.length} Einträge</span></div><div class="manager-groups">${fixedManagerGroups(categories)||'<div class="manager-empty">Keine passenden Positionen.</div>'}</div></div>
