...
(function(root){
  ...
  function sortCategories(){if(typeof root.sortCategoriesInPlace==='function')root.sortCategoriesInPlace();}
  ...
  function add(values,makeId){
    ...
    if(typeof root.syncLoanCategory==='function')root.syncLoanCategory(loan);
  ...
  function remove(id){
    ...
    if(typeof root.removeLoanCategory==='function')root.removeLoanCategory(id);
