...
(function(root){
  ...
  function normalizeState(raw){
    ...
    return {
      schemaVersion:7,data:source.data&&typeof source.data==='object'&&!Array.isArray(source.data)?source.data:{},
      cats:Array.isArray(source.cats)?source.cats:[],kredite:Array.isArray(source.kredite)?source.kredite:[],years:Array.isArray(source.years)&&source.years.length?source.years:defaultYears(),
      ...
      amountAdjustments:Array.isArray(source.amountAdjustments)?source.amountAdjustments:[],oneTimeEntries:Array.isArray(source.oneTimeEntries)?source.oneTimeEntries:[],accountBalances:source.accountBalances&&typeof source.accountBalances==='object'&&!Array.isArray(source.accountBalances)?source.accountBalances:{},
      forecastAssets:source.forecastAssets&&typeof source.forecastAssets==='object'&&!Array.isArray(source.forecastAssets)?source.forecastAssets:{},forecastAssumptions:source.forecastAssumptions&&typeof source.forecastAssumptions==='object'&&!Array.isArray(source.forecastAssumptions)?source.forecastAssumptions:{},
  ...
  function load(){
    ...
    if(!saved)root.DataManagementStore.applyFactoryState();
      ...
      S.recurringRules=saved.recurringRules;S.annualAdjustments=saved.annualAdjustments;S.percentageAdjustments=saved.percentageAdjustments;S.amountAdjustments=saved.amountAdjustments;S.oneTimeEntries=saved.oneTimeEntries;S.accountBalances=saved.accountBalances;
