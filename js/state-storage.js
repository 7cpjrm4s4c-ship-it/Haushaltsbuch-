...
(function(){
  ...
  function normalizeState(raw){
    ...
    return {
      schemaVersion:5,data:source.data&&typeof source.data==='object'&&!Array.isArray(source.data)?source.data:{},
      ...
      amountAdjustments:Array.isArray(source.amountAdjustments)?source.amountAdjustments:[],oneTimeEntries:Array.isArray(source.oneTimeEntries)?source.oneTimeEntries:[],
  ...
  load=function loadState(){
    ...
    if(!saved)applyFactoryState();
      ...
      S.forecastAssets=saved.forecastAssets;S.forecastAssumptions=saved.forecastAssumptions;S.financialEvents=saved.financialEvents;S.forecastScenarios=saved.forecastScenarios;normalizeVariableCategories();
    }
