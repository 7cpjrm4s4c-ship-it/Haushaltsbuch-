...
(function(){
  ...
  function normalizeState(raw){
    ...
    return {
      schemaVersion:4,data:source.data&&typeof source.data==='object'&&!Array.isArray(source.data)?source.data:{},
      ...
      financialEvents:Array.isArray(source.financialEvents)?source.financialEvents:[],
    };
  }
  ...
  load=function loadState(){
    ...
    if(!saved)applyFactoryState();
      ...
      S.forecastAssets=saved.forecastAssets;S.forecastAssumptions=saved.forecastAssumptions;S.financialEvents=saved.financialEvents;normalizeVariableCategories();
    }
