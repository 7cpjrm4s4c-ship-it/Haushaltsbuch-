...
(function(root){
  ...
  function normalize(raw,options={}){
    ...
    return {
      ...
      forecastAssumptions:normalizeForecastAssumptions(source.forecastAssumptions),financialEvents:normalizeFinancialEvents(source.financialEvents),forecastScenarios:normalizeForecastScenarios(source.forecastScenarios,currentYear),
    };
  }

  root.StateSchema=Object.freeze({CURRENT_VERSION,ASSET_FIELDS:Object.freeze([...ASSET_FIELDS]),normalize,isRecord,normalizeForecastAssumptions,normalizeFinancialEvents,normalizeForecastScenarios});
