...
function deleteBooking(id){
  const b=S.buchungen.find(x=>x.id===id);if(!b||!confirm('Diese Buchung wirklich löschen?'))return;
  S.buchungen=S.buchungen.filter(x=>x.id!==id);persist();render();toast('Buchung gelöscht');
}
