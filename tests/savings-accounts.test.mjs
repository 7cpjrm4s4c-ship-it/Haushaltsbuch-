...
const consistencySource=await readFile(new URL('../js/data-consistency.js',import.meta.url),'utf8');
...
assert.deepEqual(JSON.parse(JSON.stringify(context.SavingsStore.monthlyTotals(2026,1))),{regularDeposits:100,individualDeposits:0,deposits:100,withdrawals:50});
