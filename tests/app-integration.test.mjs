...
// Planungslogik + Dashboard-Monatsberechnung
{
  ...
  assert.equal(context.gv(2026,1,quarterly),0);assert.equal(context.gv(2026,2,quarterly),120);assert.equal(context.gv(2026,5,quarterly),120);assert.equal(context.gv(2026,11),0);
