...
result=goals.evaluateGoal({id:'o',title:'Später',type:'netWorth',targetAmount:100000,targetYear:2027,targetMonth:0,enabled:true},forecast);assert.equal(result.status,'missed','Ziel nach letztem Forecastmonat aber mit vorhandenen Monaten bleibt bis verfügbarem Ende nicht erreicht');
