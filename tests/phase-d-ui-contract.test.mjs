...
assert.match(cssByFile['css/modules.css'],/\.header-menu\{[^}]*background:#e5e7eb;color:#111318/,'Header-Menü braucht einen deckenden hellgrauen Hintergrund mit schwarzer Schrift');
assert.match(cssByFile['css/modules.css'],/\.header-menu button\{[^}]*background:#f3f4f6;color:#111318/,'Header-Menüeintrag braucht eine helle Fläche mit schwarzer Schrift');
